...
class CalendarHelper {
      ...
      public static function getWeekday($date) {
          $daynames = array('Chủ nhật', 'Thứ hai', 'Thứ ba', 'Thứ tư','Thứ năm','Thứ sáu', 'Thứ bảy');
      ...
      public static function convertSolar2Lunar($dd, $mm, $yy, $timeZone) {
      ...
      public static function convertLunar2Solar($lunarDay, $lunarMonth, $lunarYear, $lunarLeap, $timeZone) {
            if ($lunarMonth < 11) {
